# -*- coding: utf-8 -*-
"""
카테고리 '대한민국의 로맨틱코미디 드라마'에서 모든 컬럼(ㄱ/ㄴ/ㄷ …) + 페이지네이션까지 훑어서
각 항목 상세 페이지의 '제목 / 장르 / 방송사'만 추출하여 CSV 저장.

출력: romantic_comedy_dramas_all.csv (UTF-8 with BOM), 컬럼: title, genre, broadcaster
"""
...
def main():
    ...
    out = "romantic_comedy_dramas_all.csv"
