# -*- coding: utf-8 -*-
"""
카테고리 '대한민국의 웹 드라마'에서 모든 컬럼(ㄱ/ㄴ/ㄷ …) + 페이지네이션까지 훑어서
각 항목 상세 페이지의 '제목 / 장르 / 방송사'만 추출하여 CSV 저장.
저장 전에 genre_name 자동 보정:
  1) 비었거나 결측 → "웹드라마"
  2) "웹드라마" 미포함 → "웹드라마, {기존장르}"

출력: web_dramas_all.csv (UTF-8 with BOM), 컬럼: title, genre_name, channel_name
"""
...
CATEGORY_URL = "https://ko.wikipedia.org/wiki/%EB%B6%84%EB%A5%98:%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD%EC%9D%98_%EC%9B%B9%EB%93%9C%EB%9D%BC%EB%A7%88"
